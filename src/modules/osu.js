...
class OsuModule extends ModuleBase {
    constructor() {
        ...
        this.add_command({
            match: message => {
                if (!message.content.startsWith("osu limit"))
                    return null;
        ...
        this.add_command({
            ...
            sample: "!list following __*optional mode*__ (standard, taiko, mania, ctb)",
        ...
        this.add_command({
            ...
            description: "~~Removes the specified person from my following list for osu!~~ Not working. please choose wisely",
        ...
        this.add_command({
            ...
            description: "Forces me to check the specified person for scores that maybe i missed.",
    ...
    on_new_record(profile, record) {
        for (let i = 0; i < profile.servers.length; i++) {
            ...
            embed.addField(`Map links`, `[Map link](https://osu.ppy.sh/b/${record.beatmap_id}) | [Osu direct](osu://b/${record.beatmap_id})`, false)
                .addField(`User profile`, `[${record.user}](https://osu.ppy.sh/u/${profile.user_id})`)
                .addField(`\u200b`, `This score has been tracked by [Tsukibot!](https://osu.ppy.sh/u/9128934)`);
