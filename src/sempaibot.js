	...
	class Bot {
	    ...
	    handle_message(message) {
	        ...
	        if (message.content.toLowerCase().indexOf("tsuki") === 0 || message.content.indexOf("!") === 0) {
	            var msg = message.content;
	            if (msg.toLowerCase().indexOf("tsuki") === 0) {
	                msg = msg.substr("tsuki".length + 1).replace(/\s+/g, " ").trim();
	            } else {
